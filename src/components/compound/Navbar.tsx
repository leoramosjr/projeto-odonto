...
export default function Navbar() {
    return (
        <div className="w-full h-20 bg-neutral-950 flex justify-between items-center px-24 fixed top-0 z-50">
            ...
            <div className="h-full flex gap-12 align-middle items-center content-center">
                ...
                <div className={`w-32 h-12 rounded-full p-0.5 justify-center content-center bg-gradient-to-r from-cyan-400 to-indigo-900`}>
                    <div className={`h-full w-full bg-neutral-950 text-white rounded-full justify-center content-center flex border-0 relative`}>
